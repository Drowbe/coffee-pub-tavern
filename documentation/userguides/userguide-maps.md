...
5. Under Maps' settings, pick the **Map file**. Until you do, Maps says so.
...
- **Look at a place.** Click a pin to open its callout over the map: its name, where it is and where it comes from. **Open in my maps app** hands the place to the maps app on your device, which is where directions come from. **Copy coordinates** copies its position. **Open** takes you to the place or item in its own module, where you change it; the map itself changes nothing. To browse the list of places, use Places, which also shows a place on the map when you click it.
