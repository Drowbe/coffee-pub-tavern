...
3. On the Modules tab, choose **Install** beside Maps under **Available with this Magpie**, then **Approve and enable**. It asks to link to other modules' items and to ask other modules to do things.
