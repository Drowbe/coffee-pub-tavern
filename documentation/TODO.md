...
- The dashboard: phase 1 is built (Who is around and the Calendar widget); the To-do and Polls widgets, opening items into a room's pane, and retiring the header items are next. See plans/plan-dashboard.md.
