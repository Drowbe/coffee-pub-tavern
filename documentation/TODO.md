...
- The dashboard: built with Who is around and the Calendar, To-do and Polls widgets; opening an item straight into a room's pane (it opens the module's page in the room for now) and retiring the header items are next. See plans/plan-dashboard.md.
