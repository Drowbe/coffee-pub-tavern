...
[Environment templates](plans/plan-environment-templates.md), built on top of this plan, is **done**
(September 25, 2026): the words, module display names and icons, and the templates themselves.
