...
// The AI service (server-wide). The person picks a company by name and Tavern knows its address; the models are listed from the company's own
// list (asked with the key), not typed. The key is write-only: the page is told only whether one is set, and a typed key replaces it.
const AI_NOTICES = {
